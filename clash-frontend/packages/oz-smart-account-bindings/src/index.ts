...
export interface Client {
   ...
   * `e.invoke_contract()`.
   */
  execute: ({target, target_fn, target_args}: {target: string, target_fn: string, target_args: Array<any>}, options?: {
    /**
   ...
   */
  get_policy_id: ({policy}: {policy: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   * registered in the global registry.
   */
  get_signer_id: ({signer}: {signer: Signer}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  batch_add_signer: ({context_rule_id, signers}: {context_rule_id: u32, signers: Array<Signer>}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   */
  get_context_rules: ({context_rule_type}: {context_rule_type: ContextRuleType}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
     ...
     */
    simulate?: boolean;
  }) => Promise<AssembledTransaction<Array<ContextRule>>>
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
        ...
        "AAAAAAAAAEZDcmVhdGVzIGEgZGVmYXVsdCBjb250ZXh0IHJ1bGUgd2l0aCB0aGUgcHJvdmlkZWQgc2lnbmVycyBhbmQgcG9saWNpZXMuAAAAAAANX19jb25zdHJ1Y3RvcgAAAAAAAAIAAAAAAAAAB3NpZ25lcnMAAAAD6gAAB9AAAAAGU2lnbmVyAAAAAAAAAAAACHBvbGljaWVzAAAD7AAAABMAAAAAAAAAAA==",
        ...
        "",
